...
const AddReviewForm = () => {
  ...
  const handleTextChange = (evt) => {
    ...
    setReviewForm({...reviewForm, text: value});
  };
      ...
      <form onSubmit={handleSubmit} className="add-review__form">
        <div className="rating">
          <div className="rating__stars">
            <input className="rating__input" id="star-1" type="radio" name="rating" value="1" onChange={handleRatingChange} required/>
        ...
        <div className="add-review__text">
          <textarea minLength="50" maxLength="400" className="add-review__textarea" name="review-text" id="review-text" placeholder="Review text" onChange={handleTextChange}></textarea>
